...
//
// class PredModel {
//   late Map<String, int> myMap;
//   //pulling data from our ml model
//
//   Future<void> predData() async {
//     final interpreter1 = await Interpreter.fromAsset('btc.tflite');
//     final interpreter2 = await Interpreter.fromAsset('eth.tflite');
//     final interpreter3 = await Interpreter.fromAsset('solana.tflite');
//     final interpreter4 = await Interpreter.fromAsset('bnb.tflite');
//     final interpreter5 = await Interpreter.fromAsset('cardano.tflite');
//     var input1 = [0.006417];
//     var input2 = [0.006417];
//     var input3 = [0.006417];
//     var input4 = [0.006417];
...
//   }
//
//   int? getValue(String key) => myMap[key];
// }
